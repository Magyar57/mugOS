...
$(TOOLCHAIN_PREFIX)/bin/$(TARGET)-ld: | $(TOOLCHAIN_PATH)
	...
	../binutils-src/configure --target=$(TARGET) --prefix=$(TOOLCHAIN_PREFIX) --with-sysroot --disable-nls --disable-werror
...
$(TOOLCHAIN_PREFIX)/bin/$(TARGET)-gcc: | $(TOOLCHAIN_PATH)
	...
	../gcc-src/configure --target=$(TARGET) --prefix=$(TOOLCHAIN_PREFIX) --disable-nls --enable-languages=c,c++ --without-headers
