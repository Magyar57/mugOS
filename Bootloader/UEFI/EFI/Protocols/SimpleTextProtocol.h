...
// SimpleTextProtocol.h: SIMPLE_TEXT_INPUT_PROTOCOL & SIMPLE_TEXT_OUTPUT_PROTOCOL implementation
...
typedef struct s_EFI_SIMPLE_TEXT_INPUT_PROTOCOL EFI_SIMPLE_TEXT_INPUT_PROTOCOL;

typedef struct s_EFI_INPUT_KEY {
	UINT16 ScanCode;
	CHAR16 UnicodeChar;
} EFI_INPUT_KEY;
...
typedef struct s_EFI_SIMPLE_TEXT_INPUT_PROTOCOL {
...
// EFI Colors (EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL.SetAttribute() Attribute argument)
